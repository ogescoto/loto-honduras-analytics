...
5. **Reutiliza el Design System.** Ver [`Design.md`](Design.md). No reinventes componentes base.
...
[`Design.md`](Design.md)) + una **guardia de reentrada** en
...
## Reglas
- **Todo componente contempla los 5 estados** (carga, vacío, error, éxito, parcial) cuando aplica (ver [`Design.md`](Design.md)).
...
## Relacionado
- [`State_Management.md`](State_Management.md), [`Performance.md`](Performance.md), [`Design.md`](Design.md)
