...
Cada paso relevante de cara al usuario se anota para que **`doc-mapper`** genere la página del manual (texto; captura opcional). Ver [`../gobernanza/User_Manual_Standard.md`](../gobernanza/User_Manual_Standard.md).
...
## Relacionado
- [`Testing_Strategy.md`](Testing_Strategy.md), [`../gobernanza/User_Manual_Standard.md`](../gobernanza/User_Manual_Standard.md), [`Accessibility.md`](Accessibility.md)
