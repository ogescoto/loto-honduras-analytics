...
5. **Sin downtime** cuando sea posible (ver patrón expand/contract en [`Migrations.md`](Migrations.md)).
...
- **Logs** estructurados con `trace_id` (ver [`Error_Handling.md`](Error_Handling.md)).
...
## Relacionado
- [`CI_CD.md`](CI_CD.md), [`Environments.md`](Environments.md), [`Migrations.md`](Migrations.md), [`../Checklists/Release.md`](../Checklists/Release.md)
