...
## Principios
- **El modelo refleja el dominio**, no al revés. Empieza por las entidades del bounded context (ver [`Module_Organization.md`](Module_Organization.md)).
...
## Relacionado
- [`Naming_Conventions.md`](Naming_Conventions.md), [`Migrations.md`](Migrations.md), [`Seeds_Strategy.md`](Seeds_Strategy.md)
