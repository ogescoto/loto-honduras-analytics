...
## Módulos protegidos
Cualquier módulo puede marcarse como protegido en `.aicodeprotect.yml`. Los agentes tienen **prohibido** modificar código de módulos protegidos sin aprobación explícita (ver [`../gobernanza/Protected_Modules.md`](../gobernanza/Protected_Modules.md)).
