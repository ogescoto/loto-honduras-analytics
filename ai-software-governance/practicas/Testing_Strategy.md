...
5. **Los tests usan los seeds de test** (ver [`Seeds_Strategy.md`](Seeds_Strategy.md)), aislados y deterministas.
...
- E2E de flujos clave se anotan con `@manual-step` para el manual de usuario (ver [`../gobernanza/User_Manual_Standard.md`](../gobernanza/User_Manual_Standard.md)).
