...
Deben documentarse en [`Environments.md`](Environments.md) y en el `Makefile`/`package.json` del proyecto. Ejemplo:
...
## Relacionado
- [`Naming_Conventions.md`](Naming_Conventions.md), [`Migrations.md`](Migrations.md)
