...
9. Docs check   → (opcional) enlaces de bóveda; la coherencia la garantiza `doc-mapper`
...
> La validación de enlaces de la bóveda es **opcional** en CI: la fuente de verdad la mantiene `doc-mapper` (ver [`../gobernanza/Subagents.md`](../gobernanza/Subagents.md)). Si quieres una red de seguridad, añade `check_obsidian_links.py` como check no bloqueante.
...
- Ver [`Security.md`](Security.md) y [`Secrets_Management.md`](Secrets_Management.md).
...
## Relacionado
- [`Git_GitHub_Standards.md`](Git_GitHub_Standards.md), [`Deployment.md`](Deployment.md), [`Environments.md`](Environments.md), [`Secrets_Management.md`](Secrets_Management.md), [`Coverage_Requirements.md`](Coverage_Requirements.md)
