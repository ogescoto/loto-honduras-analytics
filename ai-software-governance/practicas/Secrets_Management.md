...
6. **No loguear secretos.** Ver [`Security.md`](Security.md).
...
## Relacionado
- [`Security.md`](Security.md), [`Environments.md`](Environments.md), [`CI_CD.md`](CI_CD.md), [`../gobernanza/Forbidden_Actions.md`](../gobernanza/Forbidden_Actions.md)
