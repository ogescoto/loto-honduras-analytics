...
- **Política afectada:** practicas/Coverage_Requirements.md (cobertura diff 85%)
...
## Registro
- Toda excepción a `standard`/`mandatory` queda como ADR en `docs/02_Arquitectura/adr/` (proyecto) o en [`ADR.md`](ADR.md) (framework).
- El [`Policy_Index.md`](Policy_Index.md) puede enlazar excepciones vigentes relevantes.

## Rol del agente
- El agente **no se auto-concede** excepciones. Detecta el conflicto, lo expone y espera decisión humana (ver [`Forbidden_Actions.md`](Forbidden_Actions.md)).
...
## Relacionado
- [`Policy_Index.md`](Policy_Index.md), [`ADR.md`](ADR.md), [`../GOVERNANCE.md`](../GOVERNANCE.md), [`Forbidden_Actions.md`](Forbidden_Actions.md)
